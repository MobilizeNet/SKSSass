...
namespace SKS
{
      ...
      : Mobilize.Web.Form
   {
      ...
      private void lvProducts_ItemClick(Mobilize.Web.ListViewItem Item) => DoSearchStocks();

      private void lvStocks_ItemClick(Mobilize.Web.ListViewItem Item) => RetrieveDataProduct();
